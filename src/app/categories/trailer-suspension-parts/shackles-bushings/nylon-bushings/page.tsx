...
export default function NylonBushingsPage() {
  return (
    <main className="max-w-2xl mx-auto py-12 px-6">
      ...
      <p className="mb-8 text-[#05203C]">Nylon bushings offer smooth movement and corrosion resistance for trailer suspension systems. They are lightweight and ideal for light-duty trailers.</p>
